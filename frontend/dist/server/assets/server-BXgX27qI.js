...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CCFPf7AG.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-X-RD508Q.js").then((n2) => n2.A),
    import("./start-BZjA2avx.js"),
...
var ROUTER_BASEPATH = "Certificadora-de-Competencia-Identitaria";
var SERVER_FN_BASE = "/Certificadora-de-Competencia-Identitaria/_serverFn/";
